...
//       }
//       builder.append(
//           "\nPlease log in to approve or deny the request. Failure to approve or deny an
// unauthorized request could result in loss of funds.");
//       if (count > 0) {
...
//     manager.enqueueUniquePeriodicWork(workId, ExistingPeriodicWorkPolicy.KEEP,
// messagesWorkRequest);
//   }
